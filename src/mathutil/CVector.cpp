...
crossProduct(
	...
	return CVector(
		vector0_in.value_[1] * vector1_in.value_[2] - vector0_in.value_[2] * vector1_in.value_[1],
		vector0_in.value_[2] * vector1_in.value_[0] - vector0_in.value_[0] * vector1_in.value_[2],
		vector0_in.value_[0] * vector1_in.value_[1] - vector0_in.value_[1] * vector1_in.value_[0],
		0.0
	);
